# -*- coding: utf-8 -*-
"""
Created on Thu Mar  8 15:54:12 2018
...
k=1
with open('USARelease.csv', 'a',newline='') as myFile:
    writer = csv.writer(myFile)
    for i in moviesList_file.index:
        movie=moviesList_file['title'][i]
        titletag=moviesList_file['position'][i]
        ...
        arraylist=[[movie, usRel,usaFirstPremiereName,usaFirstPremiereDate,usaFirstFilmFestivalName,usaFirstFilmFestivalDate,globalRelCountry,globalRelCountryDate,globalFirstPremiereName,globalFirstPremiereDate,globalFirstFilmFestivalName,globalFirstFilmFestivalDate]]
